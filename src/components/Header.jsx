...
import {assets} from '../assets/assets'
 ...
 const Header = () => {
  return (
    <div  className='flex-col md:flex-row flex-wrap bg-pink-400 rounded-lg px-6 md:px-10 lg:px-20'>
        {/*--leftside--*/}
...
<div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
    ...
    <p>Simply brower through our extensive list of trusted doctors,<br></br> schedule your appoitment hassle-free.</p>
</div>
<a href="#speciality" className='flex items-center gap-2 bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300'>
    Book Appointment <img src={assets.arrow_icon}/>
          ...
          {/*---------right-side*/}
       <div className=' float-right md:w-1/2 relative'>
